...
define config.name = _("URFU PROJECT")
...
define config.save_directory = "URFUPROJECT-1759072225"
...
define centerright = Position(xalign=0.75, yalign=1.0)
define centerleft = Position(xalign=0.25, yalign=1.0)
